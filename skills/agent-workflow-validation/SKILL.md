...
description: "Validate repository agent creation workflows, including grill-me alignment, find-skills discovery, skill composition, agent-doc generation, and security checks. Use when testing a new agent before deployment or when you need a safe end-to-end workflow rehearsal."
---
...
3. Inspect the local agent files and nearby agents before writing a new agent.
...
6. Run `node scripts/setup.js --dry-run` and `npm run agent:sync` before handoff.
